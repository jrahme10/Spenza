...
export default function App(){
 ...
 return <div className="shell"><main className="phone">
  ...
  <section className="quick"><button onClick={()=>setOpen(true)}><i><Plus/></i><span>Add expense</span></button><button><i><WalletCards/></i><span>Wallets</span></button><button><i><BarChart3/></i><span>Insights</span></button><button><i><Sparkles/></i><span>Ask Velora</span></button></section>
